...
import asyncio
import typing as t
from tdl_xoa_driver import enums, testers
from tdl_xoa_driver.utils import apply
from tdl_xoa_driver.internals.hli_v2.ports.port_l23.family_l import FamilyL
from tdl_xoa_driver.internals.hli_v2.ports.port_l23.family_l1 import FamilyL1
from tdl_xoa_driver.ports import GenericAnyPort
from tdl_xoa_driver.modules import GenericAnyModule, GenericL23Module, ModuleChimera, Z800FreyaModule
from tdl_xoa_driver.testers import GenericAnyTester, L23Tester
...
async def reserve_tester(tester: GenericAnyTester, force: bool = True) -> None:
    ...
    :type tester: :class:`~tdl_xoa_driver.testers.GenericAnyTester`
...
async def get_chassis_sys_uptime_sec(tester: L23Tester) -> int:
    ...
    :param tester: The tester to free
    :type tester: :class:`~tdl_xoa_driver.testers.L23Tester`
...
def get_module(tester: GenericAnyTester, module_id: int) -> GenericAnyModule:
    ...
    :rtype: :class:`~tdl_xoa_driver.modules.GenericAnyModule`
    """
...
async def reserve_module(module: GenericAnyModule, force: bool = True) -> None:
    ...
    :type module: :class:`~tdl_xoa_driver.modules.GenericAnyModule`
