...
if TYPE_CHECKING:
    from tdl_xoa_driver.internals.core.transporter.protocol.struct_response import Response
    from tdl_xoa_driver.internals.core.transporter._typings import XoaCommandType
