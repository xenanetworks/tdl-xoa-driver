...
from tdl_xoa_driver.internals.hli_v1.ports import base_port
...
from tdl_xoa_driver.internals.utils.indices import index_manager as im
from tdl_xoa_driver.internals.hli_v1.indices.connection_group.cg import ConnectionGroupIdx
...
class PortL47(base_port.BasePort["ports_state.PortL47LocalState"]):
    ...
    def __init__(self, conn: "itf.IConnection", module_id: int, port_id: int) -> None:
        ...
        :type: ~tdl_xoa_driver.internals.hli_v1.ports.port_l47.packet_engine.PacketEngine
        """
