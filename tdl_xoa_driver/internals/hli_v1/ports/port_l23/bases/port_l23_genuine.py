...
if TYPE_CHECKING:
    from tdl_xoa_driver.internals.core import interfaces as itf
from tdl_xoa_driver.internals.commands import (
    P_FLASH,
    P_SPEEDSELECTION,
    P_SPEEDS_SUPPORTED,
    P_UAT_MODE,
...
from tdl_xoa_driver.internals.utils import attributes as utils
from tdl_xoa_driver.internals.utils.indices import index_manager as idx_mgr
from tdl_xoa_driver.internals.hli_v1.indices.streams.genuine_stream import GenuineStreamIdx
from tdl_xoa_driver.internals.hli_v1.indices.filter.genuine_filter import GenuineFilterIdx
from tdl_xoa_driver.internals.hli_v1.indices.port_dataset import PortDatasetIdx
from tdl_xoa_driver.internals.state_storage import ports_state
from tdl_xoa_driver.internals.hli_v1.indices.macsecscs.genuine_macsecsc import GenuineMacSecTxScIdx, GenuineMacSecRxScIdx
