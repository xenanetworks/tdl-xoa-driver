...
async def __write_data_block_loop(port: GenericL23Port, cdb_instance: int, firmware_filename: str, firmware_header_size: int, erased_byte: str, use_epl_write: bool, use_abort_for_failure: bool) -> bool:
...
async def __abort_firmware_download(port: GenericL23Port, cdb_instance: int, use_abort_for_failure: bool) -> None:
