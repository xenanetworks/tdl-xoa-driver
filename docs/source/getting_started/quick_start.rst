...
The XOA Driver offers more than just object-oriented APIs and functions for executing test scripts. It also provides a seamless integration with `XOA CLI commands <https://docs.xenanetworks.com/projects/tdl-xoa-cli>`_ and port configuration files from XenaManager.
, enabling you to effortlessly work with them.

.. note::

    Integration with CLI commands and XenaManager is supported by version >= 2.1.1.
