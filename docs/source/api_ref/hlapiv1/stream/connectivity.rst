...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.ps_commands.PS_IPV4GATEWAY`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.ps_commands.PS_IPV6GATEWAY`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.ps_commands.PS_ARPREQUEST`
...
:class:`~tdl_xoa_driver.internals.commands.ps_commands.PS_ARPREQUEST`. This command does not generate an immediate result, but
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.ps_commands.PS_PINGREQUEST`
