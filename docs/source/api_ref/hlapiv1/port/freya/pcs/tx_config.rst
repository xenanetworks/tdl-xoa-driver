...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.pp_commands.PP_ALARMS_ERRORS`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.pp_commands.PP_TXERRORRATE`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.pp_commands.PP_TXINJECTONE`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.pp_commands.PP_TXLANEINJECT`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.pp_commands.PP_TXLANECONFIG`
