...
when capture is enabled with :class:`~tdl_xoa_driver.internals.commands.p_commands.P_CAPTURE``, the actual capturing of packets can be
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.pc_commands.PC_TRIGGER`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.pc_commands.PC_KEEP`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.p_commands.P_CAPTURE`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.pc_commands.PC_STATS`
...
truncated if the :class:`~tdl_xoa_driver.internals.commands.pc_commands.PC_KEEP` command specified a limit on the number of bytes kept.

Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.pc_commands.PC_PACKET`
