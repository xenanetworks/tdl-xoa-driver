...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.c_commands.C_TIME`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.c_commands.C_TKCONFIG`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.c_commands.C_TKGPSSTATE`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.c_commands.C_TKLICFILE`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.c_commands.C_TKLICSTATE`
...
Corresponding low-level API class: :class:`~tdl_xoa_driver.internals.commands.c_commands.C_TKSTATUS`
